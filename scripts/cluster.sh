...
# Extract OTU table
qiime tools export --input-path $vsearch_outdir/table.qza --output-path $vsearch_outdir
...
sed '1d' $vsearch_outdir/feature-table.tsv > $OUTPUTDIR/"$PROJECTNAME"_SILVA99.tsv
