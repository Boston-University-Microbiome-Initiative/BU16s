...
if [ $PAIRED == "True" ]
then
    cmd="qiime dada2 denoise-paired --p-trunc-len-f $TRUNC_LEN_F --p-trunc-len-r $TRUNC_LEN_R $dada2_params"
else
    cmd="qiime dada2 denoise-single --p-trunc-len $TRUNC_LEN_F $dada2_params"
fi
echo --------------------------------------------------------------------------------------
echo $cmd
echo --------------------------------------------------------------------------------------
